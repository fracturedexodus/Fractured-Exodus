...
public static class MissionTileCatalog
{
	...
	private static readonly Vector2 DoorScale = Vector2.One;
	...
	private static readonly List<MissionTileDefinition> Definitions = new List<MissionTileDefinition>
	{
		...
		new MissionTileDefinition("wall_se_window", "Window SE Wall", MissionTileCategory.Wall, 'A', new Rect2(0, 0, 226, 360), Vector2.Zero, Vector2.One, AlignedRoot + "walls/wall_SE_panel_window.png"),
		new MissionTileDefinition("wall_sw_window", "Window SW Wall", MissionTileCategory.Wall, 'G', new Rect2(0, 0, 226, 360), Vector2.Zero, Vector2.One, AlignedRoot + "walls/wall_SW_panel_window.png"),

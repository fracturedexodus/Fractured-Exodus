		...
		{
			{
				...
				new OfficerTemplate
				{
					...
					Name = "Lyra Voss",
					PortraitPath = "res://Ships/AetherSkimmer.png",
			...
			},
			{
				...
				new OfficerTemplate
				{
					...
					Name = "Cassian Rook",
					PortraitPath = "res://Ships/ValkyrieWing.png",
			...
			},
			{
				...
				new OfficerTemplate
				{
					...
					Name = "Mara Ilyan",
					PortraitPath = "res://Ships/GenesisArk.png",
			...
			},
			{
				...
				new OfficerTemplate
				{
					...
					Name = "Dr. Soren Vale",
					PortraitPath = "res://Ships/PanaceaSpire.png",
			...
			},
			{
				...
				new OfficerTemplate
				{
					...
					Name = "Tamsin Kreel",
					PortraitPath = "res://Ships/RelicHarvester.png",
			...
			},
			{
				...
				new OfficerTemplate
				{
					...
					Name = "Brakk Tenor",
					PortraitPath = "res://Ships/NeptuneForge.png",
			...
			},
			{
				...
				new OfficerTemplate
				{
					...
					Name = "Seraph Nox",
					PortraitPath = "res://Ships/AegisBastion.png",
